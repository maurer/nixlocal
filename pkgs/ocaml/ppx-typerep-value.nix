{stdenv, buildOcaml, fetchurl, ocaml_oasis, js_build_tools, ppx_assert,
 ppx_bench, ppx_bin_prot, ppx_compare, ppx_custom_printf, ppx_driver,
 ppx_enumerate, ppx_expect, ppx_fail, ppx_fields_conv, ppx_hash, ppx_here,
...
buildOcaml rec {
  ...
  src = fetchurl {
    ...
    sha256 = "x8k81d59h5m09a66wjxm39p0n1shk2j6clykr9imigbhfh7jq22x";
  };

  hasSharedObjects = true;

  buildInputs = [ ocaml_oasis js_build_tools ];
  propagatedBuildInputs =
    [ ppx_assert ppx_bench ppx_bin_prot ppx_compare ppx_custom_printf
      ppx_driver ppx_enumerate ppx_expect ppx_fail ppx_fields_conv ppx_hash
